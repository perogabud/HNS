<?php
class PageCoverImage extends ModelObject {
  ...
  public function getPath () {
    return Config::read ('sitePath') . 'img/page/coverImage/' . $this->_filename;
  }

  public function getUrl () {
    return $this->_rootUrl . '/img/page/coverImage/' . $this->_filename;
  }

  public function getLargeThumbnailUrl () {
    return $this->_rootUrl . '/img/page/coverImage/largeThumbnail/' . $this->_filename;
  }

  public function getLargeThumbnailPath () {
    return Config::read ('sitePath') . 'img/page/coverImage/largeThumbnail/' . $this->_filename;
  }  

  public function getSmallThumbnailUrl () {
    return $this->_rootUrl . '/img/page/coverImage/smallThumbnail/' . $this->_filename;
  }

  public function getSmallThumbnailPath () {
    return Config::read ('sitePath') . 'img/page/coverImage/smallThumbnail/' . $this->_filename;
  }  
